# Guam — World Universities Database

1 records for **Guam** (Guam).
...
| **Excel / CSV / PDF** (Guam only) | [listbase.org](https://listbase.org/en/education/) |

## Preview

| name | country | alpha_two_code | state_province | domains | web_pages |
| --- | --- | --- | --- | --- | --- |
| University of Guam | Guam | GU |  | uog.edu | http://www.uog.edu/ |

## Schema

```sql
SELECT * FROM universities WHERE country = 'Guam';
```
...
📊 **[Download Guam data as Excel/CSV/PDF](https://listbase.org/en/education/)**
