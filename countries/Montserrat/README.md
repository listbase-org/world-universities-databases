# Montserrat — World Universities Database

1 records for **Montserrat** (Montserrat).
...
| **Excel / CSV / PDF** (Montserrat only) | [listbase.org](https://listbase.org/en/education/) |

## Preview

| name | country | alpha_two_code | state_province | domains | web_pages |
| --- | --- | --- | --- | --- | --- |
| University of Science, Arts and Technolo | Montserrat | MS |  | usat.ms | http://www.usat.ms/ |

## Schema

```sql
SELECT * FROM universities WHERE country = 'Montserrat';
```
...
📊 **[Download Montserrat data as Excel/CSV/PDF](https://listbase.org/en/education/)**
