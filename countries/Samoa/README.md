# Samoa — World Universities Database

1 records for **Samoa** (Samoa).
...
| **Excel / CSV / PDF** (Samoa only) | [listbase.org](https://listbase.org/en/education/) |

## Preview

| name | country | alpha_two_code | state_province | domains | web_pages |
| --- | --- | --- | --- | --- | --- |
| National University of Samoa | Samoa | WS |  | nus.edu.ws | http://www.nus.edu.ws/ |

## Schema

```sql
SELECT * FROM universities WHERE country = 'Samoa';
```
...
📊 **[Download Samoa data as Excel/CSV/PDF](https://listbase.org/en/education/)**
