# Germany — World Universities Database

319 records for **Germany** (Germany).
...
| **Excel / CSV / PDF** (Germany only) | [listbase.org](https://listbase.org/en/education/) |

## Preview

| name | country | alpha_two_code | state_province | domains | web_pages |
| --- | --- | --- | --- | --- | --- |
| IU Internationale Hochschule GmbH | Germany | DE | Thuringia | iubh-fernstudium.de | https://www.iu-fernstudium.de/ |
| AKAD Hochschulen für Berufstätige, Fachh | Germany | DE |  | akad.de | http://www.akad.de/ |
| Alice-Salomon-Fachhochschule für Soziala | Germany | DE |  | asfh-berlin.de | http://www.asfh-berlin.de/ |
| Augustana Hochschule Neuendettelsau | Germany | DE |  | augustana.de | http://www.augustana.de/ |
| Kirchliche Hochschule Bethel | Germany | DE |  | bethel.de | http://www.bethel.de/kiho/ |
| BiTS - Business and Information Technolo | Germany | DE |  | bits-iserlohn.de | http://www.bits-iserlohn.de/ |
| Cologne Business School | Germany | DE |  | cbs.de | http://www.cbs.de/ |
| CODE University of Applied Sciences Berl | Germany | DE |  | code.berlin | http://code.berlin/ |
| Deutsche Hochschule für Verwaltungswisse | Germany | DE |  | dhv-speyer.de | http://www.dhv-speyer.de/ |
| DIPLOMA-Fachhochschule Ölsnitz/Vogtland | Germany | DE |  | diploma.de | http://www.diploma.de/ |
| ... | ... | ... | ... | ... | ... |

*Showing 10 of 319 records*

## Schema

```sql
SELECT * FROM universities WHERE country = 'Germany';
```
...
📊 **[Download Germany data as Excel/CSV/PDF](https://listbase.org/en/education/)**
